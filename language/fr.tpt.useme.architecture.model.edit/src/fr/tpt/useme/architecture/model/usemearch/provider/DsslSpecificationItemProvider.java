...
/**
 * This is the item provider adapter for a {@link fr.tpt.useme.architecture.model.usemearch.DsslSpecification} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DsslSpecificationItemProvider extends IdentifiedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UsemearchPackage.Literals.DSSL_SPECIFICATION__DEVELOPED_DSL,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UsemearchPackage.Literals.DSSL_SPECIFICATION__OWNED_CONTEXTS);
			childrenFeatures.add(UsemearchPackage.Literals.DSSL_SPECIFICATION__OWNED_ENTITY_TYPES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UsemearchPackage.Literals.DSSL_SPECIFICATION__OWNED_CONTEXTS,
				 UsemearchFactory.eINSTANCE.createContextSpecification()));

		newChildDescriptors.add
			(createChildParameter
				(UsemearchPackage.Literals.DSSL_SPECIFICATION__OWNED_ENTITY_TYPES,
		...
		newChildDescriptors.add
			(createChildParameter
				(UsemearchPackage.Literals.DSSL_SPECIFICATION__OWNED_ENTITY_TYPES,
				 UsemearchFactory.eINSTANCE.createHardwareTool()));
		...
		newChildDescriptors.add
			(createChildParameter
				(UsemearchPackage.Literals.DSSL_SPECIFICATION__OWNED_ENTITY_TYPES,
				 UsemearchFactory.eINSTANCE.createDisplay()));

		newChildDescriptors.add
			(createChildParameter
				(UsemearchPackage.Literals.DSSL_SPECIFICATION__OWNED_ENTITY_TYPES,
				 UsemearchFactory.eINSTANCE.createMouse()));
	}
