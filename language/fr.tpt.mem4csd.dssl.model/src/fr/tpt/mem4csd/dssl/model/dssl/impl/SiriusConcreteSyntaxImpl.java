 ...
 * </p>
 * <ul>
 *   <li>{@link fr.tpt.mem4csd.dssl.model.dssl.impl.SiriusConcreteSyntaxImpl#getSiriusSpecification <em>Sirius Specification</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SiriusConcreteSyntaxImpl extends ConcreteSyntaxImpl implements SiriusConcreteSyntax {
	...
	protected EClass eStaticClass() {
		return DsslPackage.Literals.SIRIUS_CONCRETE_SYNTAX;
	}
	...
	public EList<Group> getSiriusSpecification() {
		if (siriusSpecification == null) {
			siriusSpecification = new EObjectResolvingEList<Group>(Group.class, this, DsslPackage.SIRIUS_CONCRETE_SYNTAX__SIRIUS_SPECIFICATION);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DsslPackage.SIRIUS_CONCRETE_SYNTAX__SIRIUS_SPECIFICATION:
