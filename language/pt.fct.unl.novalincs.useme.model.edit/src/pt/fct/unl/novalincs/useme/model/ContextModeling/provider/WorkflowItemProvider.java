...
/**
 * This is the item provider adapter for a {@link pt.fct.unl.novalincs.useme.model.ContextModeling.Workflow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WorkflowItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ContextModelingPackage.Literals.WORKFLOW__NAME,
				 true,
				 false,
				 false,
	...
	protected void addPriorityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Workflow_priority_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Workflow_priority_feature", "_UI_Workflow_type"),
				 ContextModelingPackage.Literals.WORKFLOW__PRIORITY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addActorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Workflow_actor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Workflow_actor_feature", "_UI_Workflow_type"),
				 ContextModelingPackage.Literals.WORKFLOW__ACTOR,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addContextElementPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Workflow_contextElement_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Workflow_contextElement_feature", "_UI_Workflow_type"),
				 ContextModelingPackage.Literals.WORKFLOW__CONTEXT_ELEMENT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addProcessModelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Workflow_processModel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Workflow_processModel_feature", "_UI_Workflow_type"),
				 ContextModelingPackage.Literals.WORKFLOW__PROCESS_MODEL,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addContextModelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Workflow_contextModel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Workflow_contextModel_feature", "_UI_Workflow_type"),
				 ContextModelingPackage.Literals.WORKFLOW__CONTEXT_MODEL,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ContextModelingPackage.Literals.WORKFLOW__SCENARIO);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ContextModelingPackage.Literals.WORKFLOW__SCENARIO,
