...
/**
 * This is the item provider adapter for a {@link pt.fct.unl.novalincs.useme.model.EvaluationModeling.Documentation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Documentation_evaluationModel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Documentation_evaluationModel_feature", "_UI_Documentation_type"),
				 EvaluationModelingPackage.Literals.DOCUMENTATION__EVALUATION_MODEL,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addScenarioPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Documentation_scenario_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Documentation_scenario_feature", "_UI_Documentation_type"),
				 EvaluationModelingPackage.Literals.DOCUMENTATION__SCENARIO,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EvaluationModelingPackage.Literals.DOCUMENTATION__NAME,
				 true,
				 false,
				 false,
	...
	protected void addOutsideRefPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Documentation_outsideRef_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Documentation_outsideRef_feature", "_UI_Documentation_type"),
				 EvaluationModelingPackage.Literals.DOCUMENTATION__OUTSIDE_REF,
				 true,
				 false,
				 true,
				 null,
