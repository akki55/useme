...
/**
 * This is the item provider adapter for a {@link pt.fct.unl.novalincs.useme.model.EvaluationModeling.Participant} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EvaluationModelingPackage.Literals.PARTICIPANT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addContactPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Participant_contact_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Participant_contact_feature", "_UI_Participant_type"),
				 EvaluationModelingPackage.Literals.PARTICIPANT__CONTACT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addEvaluationModelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Participant_evaluationModel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Participant_evaluationModel_feature", "_UI_Participant_type"),
				 EvaluationModelingPackage.Literals.PARTICIPANT__EVALUATION_MODEL,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addUserProfilePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Participant_userProfile_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Participant_userProfile_feature", "_UI_Participant_type"),
				 EvaluationModelingPackage.Literals.PARTICIPANT__USER_PROFILE,
				 true,
				 false,
				 true,
				 null,
