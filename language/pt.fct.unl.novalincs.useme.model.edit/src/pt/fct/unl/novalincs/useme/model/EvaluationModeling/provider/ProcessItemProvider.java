...
/**
 * This is the item provider adapter for a {@link pt.fct.unl.novalincs.useme.model.EvaluationModeling.Process} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EvaluationModelingPackage.Literals.PROCESS__NAME,
				 true,
				 false,
				 false,
	...
	protected void addEvaluationModelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Process_evaluationModel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Process_evaluationModel_feature", "_UI_Process_type"),
				 EvaluationModelingPackage.Literals.PROCESS__EVALUATION_MODEL,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addProcessModelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Process_processModel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Process_processModel_feature", "_UI_Process_type"),
				 EvaluationModelingPackage.Literals.PROCESS__PROCESS_MODEL,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((pt.fct.unl.novalincs.useme.model.EvaluationModeling.Process)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(pt.fct.unl.novalincs.useme.model.EvaluationModeling.Process.class)) {
