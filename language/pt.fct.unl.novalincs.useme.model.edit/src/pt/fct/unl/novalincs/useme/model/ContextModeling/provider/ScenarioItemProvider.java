...
/**
 * This is the item provider adapter for a {@link pt.fct.unl.novalincs.useme.model.ContextModeling.Scenario} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScenarioItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addEvaluatedTaskPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ContextModelingPackage.Literals.SCENARIO__NAME,
				 true,
				 false,
				 false,
	...
	protected void addPriorityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Scenario_priority_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Scenario_priority_feature", "_UI_Scenario_type"),
				 ContextModelingPackage.Literals.SCENARIO__PRIORITY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Evaluated Task feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addEvaluatedTaskPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Scenario_evaluatedTask_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Scenario_evaluatedTask_feature", "_UI_Scenario_type"),
				 ContextModelingPackage.Literals.SCENARIO__EVALUATED_TASK,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addDocPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Scenario_doc_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Scenario_doc_feature", "_UI_Scenario_type"),
				 ContextModelingPackage.Literals.SCENARIO__DOC,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addAggregatesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Scenario_aggregates_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Scenario_aggregates_feature", "_UI_Scenario_type"),
				 ContextModelingPackage.Literals.SCENARIO__AGGREGATES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addQuestionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Scenario_question_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Scenario_question_feature", "_UI_Scenario_type"),
				 ContextModelingPackage.Literals.SCENARIO__QUESTION,
				 true,
				 false,
				 true,
				 null,
