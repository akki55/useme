...
/**
 * This is the item provider adapter for a {@link pt.fct.unl.novalincs.useme.model.SurveyModeling.Questionnaire} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SurveyModelingPackage.Literals.QUESTIONNAIRE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addQuestionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Questionnaire_question_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Questionnaire_question_feature", "_UI_Questionnaire_type"),
				 SurveyModelingPackage.Literals.QUESTIONNAIRE__QUESTION,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addSurveyModelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Questionnaire_surveyModel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Questionnaire_surveyModel_feature", "_UI_Questionnaire_type"),
				 SurveyModelingPackage.Literals.QUESTIONNAIRE__SURVEY_MODEL,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addUsabilityRequirementPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Questionnaire_usabilityRequirement_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Questionnaire_usabilityRequirement_feature", "_UI_Questionnaire_type"),
				 SurveyModelingPackage.Literals.QUESTIONNAIRE__USABILITY_REQUIREMENT,
				 true,
				 false,
				 true,
				 null,
