...
/**
 * This is the item provider adapter for a {@link fr.tpt.mem4csd.dssl.model.dssl.Dsl} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DslItemProvider extends EntityTypeItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DsslPackage.Literals.DSL__ABSTRACTSYNTAX,
				 false,
				 false,
				 false,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DsslPackage.Literals.DSL__SUPPORTING_TOOLS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DsslPackage.Literals.DSL__OWNED_SEMANTICS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DsslPackage.Literals.DSL__OWNED_FEATURE_DIAGRAMS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DsslPackage.Literals.DSL__OWNED_DOCUMENTATIONS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DsslPackage.Literals.DSL__MAINTENANCE_SERVICE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DsslPackage.Literals.DSL__OWNED_SYNTAXES);
			childrenFeatures.add(DsslPackage.Literals.DSL__OWNED_SEMANTICS);
			childrenFeatures.add(DsslPackage.Literals.DSL__OWNED_FEATURE_DIAGRAMS);
			childrenFeatures.add(DsslPackage.Literals.DSL__OWNED_DOCUMENTATIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DsslPackage.Literals.DSL__OWNED_SYNTAXES,
				 DsslFactory.eINSTANCE.createECoreAbstractSyntax()));

		newChildDescriptors.add
			(createChildParameter
				(DsslPackage.Literals.DSL__OWNED_SYNTAXES,
				 DsslFactory.eINSTANCE.createSiriusConcreteSyntax()));

		newChildDescriptors.add
			(createChildParameter
				(DsslPackage.Literals.DSL__OWNED_FEATURE_DIAGRAMS,
				 DsslFactory.eINSTANCE.createFeatureDiagram()));
	}
