...
/**
 * This is the item provider adapter for a {@link fr.tpt.mem4csd.dssl.model.dssl.EntityInstancesConnection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DsslPackage.Literals.ENTITY_INSTANCES_CONNECTION__SOURCE_FEATURE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DsslPackage.Literals.ENTITY_INSTANCES_CONNECTION__DESTINATION_FEATURE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DsslPackage.Literals.ENTITY_INSTANCES_CONNECTION__SOURCE_ENTITY_INSTANCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DsslPackage.Literals.ENTITY_INSTANCES_CONNECTION__DESTINATION_ENTITY_INSTANCE,
				 true,
				 false,
				 true,
				 null,
