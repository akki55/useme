 ...
 * </p>
 * <ul>
 *   <li>{@link fr.tpt.mem4csd.dssl.model.dssl.impl.EntityInstancesConnectionImpl#getSourceFeature <em>Source Feature</em>}</li>
 *   <li>{@link fr.tpt.mem4csd.dssl.model.dssl.impl.EntityInstancesConnectionImpl#getDestinationFeature <em>Destination Feature</em>}</li>
 *   <li>{@link fr.tpt.mem4csd.dssl.model.dssl.impl.EntityInstancesConnectionImpl#getSourceEntityInstance <em>Source Entity Instance</em>}</li>
 *   <li>{@link fr.tpt.mem4csd.dssl.model.dssl.impl.EntityInstancesConnectionImpl#getDestinationEntityInstance <em>Destination Entity Instance</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EntityInstancesConnectionImpl extends IdentifiedElementImpl implements EntityInstancesConnection {
	...
	protected EClass eStaticClass() {
		return DsslPackage.Literals.ENTITY_INSTANCES_CONNECTION;
	}
		...
		if (sourceFeature != null && sourceFeature.eIsProxy()) {
			...
			if (sourceFeature != oldSourceFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DsslPackage.ENTITY_INSTANCES_CONNECTION__SOURCE_FEATURE, oldSourceFeature, sourceFeature));
			}
		}
	...
	public void setSourceFeature(InteractionFeature newSourceFeature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DsslPackage.ENTITY_INSTANCES_CONNECTION__SOURCE_FEATURE, oldSourceFeature, sourceFeature));
	}
	...
	public InteractionFeature getDestinationFeature() {
		if (destinationFeature != null && destinationFeature.eIsProxy()) {
			...
			if (destinationFeature != oldDestinationFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DsslPackage.ENTITY_INSTANCES_CONNECTION__DESTINATION_FEATURE, oldDestinationFeature, destinationFeature));
			}
		}
	...
	public void setDestinationFeature(InteractionFeature newDestinationFeature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DsslPackage.ENTITY_INSTANCES_CONNECTION__DESTINATION_FEATURE, oldDestinationFeature, destinationFeature));
	}
	...
	public EntityInstance getSourceEntityInstance() {
		if (sourceEntityInstance != null && sourceEntityInstance.eIsProxy()) {
			...
			if (sourceEntityInstance != oldSourceEntityInstance) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DsslPackage.ENTITY_INSTANCES_CONNECTION__SOURCE_ENTITY_INSTANCE, oldSourceEntityInstance, sourceEntityInstance));
			}
		}
	...
	public void setSourceEntityInstance(EntityInstance newSourceEntityInstance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DsslPackage.ENTITY_INSTANCES_CONNECTION__SOURCE_ENTITY_INSTANCE, oldSourceEntityInstance, sourceEntityInstance));
	}
	...
	public EntityInstance getDestinationEntityInstance() {
		if (destinationEntityInstance != null && destinationEntityInstance.eIsProxy()) {
			...
			if (destinationEntityInstance != oldDestinationEntityInstance) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DsslPackage.ENTITY_INSTANCES_CONNECTION__DESTINATION_ENTITY_INSTANCE, oldDestinationEntityInstance, destinationEntityInstance));
			}
		}
	...
	public void setDestinationEntityInstance(EntityInstance newDestinationEntityInstance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DsslPackage.ENTITY_INSTANCES_CONNECTION__DESTINATION_ENTITY_INSTANCE, oldDestinationEntityInstance, destinationEntityInstance));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DsslPackage.ENTITY_INSTANCES_CONNECTION__SOURCE_FEATURE:
				if (resolve) return getSourceFeature();
				return basicGetSourceFeature();
			case DsslPackage.ENTITY_INSTANCES_CONNECTION__DESTINATION_FEATURE:
				if (resolve) return getDestinationFeature();
				return basicGetDestinationFeature();
			case DsslPackage.ENTITY_INSTANCES_CONNECTION__SOURCE_ENTITY_INSTANCE:
				if (resolve) return getSourceEntityInstance();
				return basicGetSourceEntityInstance();
			case DsslPackage.ENTITY_INSTANCES_CONNECTION__DESTINATION_ENTITY_INSTANCE:
