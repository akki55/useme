 ...
 * </p>
 * <ul>
 *   <li>{@link fr.tpt.mem4csd.dssl.model.dssl.impl.ToolImpl#getUsedBy <em>Used By</em>}</li>
 *   <li>{@link fr.tpt.mem4csd.dssl.model.dssl.impl.ToolImpl#getControlledBy <em>Controlled By</em>}</li>
 *   <li>{@link fr.tpt.mem4csd.dssl.model.dssl.impl.ToolImpl#getControls <em>Controls</em>}</li>
 *   <li>{@link fr.tpt.mem4csd.dssl.model.dssl.impl.ToolImpl#getVersion <em>Version</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ToolImpl extends EntityTypeImpl implements Tool {
	...
	protected EClass eStaticClass() {
		return DsslPackage.Literals.TOOL;
	}
	...
	public EList<User> getUsedBy() {
		if (usedBy == null) {
			usedBy = new EObjectWithInverseResolvingEList.ManyInverse<User>(User.class, this, DsslPackage.TOOL__USED_BY, DsslPackage.USER__USES);
		}
		return usedBy;
	}
	...
	public EList<Tool> getControlledBy() {
		if (controlledBy == null) {
			controlledBy = new EObjectWithInverseResolvingEList.ManyInverse<Tool>(Tool.class, this, DsslPackage.TOOL__CONTROLLED_BY, DsslPackage.TOOL__CONTROLS);
		}
		return controlledBy;
	}
	...
	public EList<Tool> getControls() {
		if (controls == null) {
			controls = new EObjectWithInverseResolvingEList.ManyInverse<Tool>(Tool.class, this, DsslPackage.TOOL__CONTROLS, DsslPackage.TOOL__CONTROLLED_BY);
		}
		return controls;
	}
	...
	public void setVersion(String newVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DsslPackage.TOOL__VERSION, oldVersion, version));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DsslPackage.TOOL__CONTROLS:
				return getControls();
			case DsslPackage.TOOL__VERSION:
				return getVersion();
		}
