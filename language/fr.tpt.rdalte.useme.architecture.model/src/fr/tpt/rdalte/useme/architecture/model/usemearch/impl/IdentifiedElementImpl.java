 ...
 * </p>
 * <ul>
 *   <li>{@link fr.tpt.rdalte.useme.architecture.model.usemearch.impl.IdentifiedElementImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.tpt.rdalte.useme.architecture.model.usemearch.impl.IdentifiedElementImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class IdentifiedElementImpl extends MinimalEObjectImpl.Container implements IdentifiedElement {
	...
	protected EClass eStaticClass() {
		return UsemearchPackage.Literals.IDENTIFIED_ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UsemearchPackage.IDENTIFIED_ELEMENT__NAME, oldName, name));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UsemearchPackage.IDENTIFIED_ELEMENT__ID, oldId, id));
	}
