 ...
 * </p>
 * <ul>
 *   <li>{@link fr.tpt.useme.architecture.model.usemearch.impl.EntityTypeImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link fr.tpt.useme.architecture.model.usemearch.impl.EntityTypeImpl#getOwnedInteractionFeatures <em>Owned Interaction Features</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class EntityTypeImpl extends IdentifiedElementImpl implements EntityType {
	...
	protected EClass eStaticClass() {
		return UsemearchPackage.Literals.ENTITY_TYPE;
	}
	...
	public EList<Category> getCategory() {
		if (category == null) {
			category = new EObjectResolvingEList<Category>(Category.class, this, UsemearchPackage.ENTITY_TYPE__CATEGORY);
		}
		return category;
	}
	...
	public EList<InteractionFeature> getOwnedInteractionFeatures() {
		if (ownedInteractionFeatures == null) {
			ownedInteractionFeatures = new EObjectContainmentEList<InteractionFeature>(InteractionFeature.class, this, UsemearchPackage.ENTITY_TYPE__OWNED_INTERACTION_FEATURES);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UsemearchPackage.ENTITY_TYPE__CATEGORY:
				return getCategory();
			case UsemearchPackage.ENTITY_TYPE__OWNED_INTERACTION_FEATURES:
