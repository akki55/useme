 ...
 * </p>
 * <ul>
 *   <li>{@link fr.tpt.useme.architecture.model.usemearch.impl.EntityInstanceImpl#getEntityType <em>Entity Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EntityInstanceImpl extends IdentifiedElementImpl implements EntityInstance {
	...
	protected EClass eStaticClass() {
		return UsemearchPackage.Literals.ENTITY_INSTANCE;
	}
		...
		if (entityType != null && entityType.eIsProxy()) {
			...
			if (entityType != oldEntityType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UsemearchPackage.ENTITY_INSTANCE__ENTITY_TYPE, oldEntityType, entityType));
			}
		}
		return entityType;
	}
	...
	public void setEntityType(EntityType newEntityType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UsemearchPackage.ENTITY_INSTANCE__ENTITY_TYPE, oldEntityType, entityType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UsemearchPackage.ENTITY_INSTANCE__ENTITY_TYPE:
