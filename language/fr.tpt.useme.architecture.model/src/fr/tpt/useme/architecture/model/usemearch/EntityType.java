 ...
 * </p>
 * <ul>
 *   <li>{@link fr.tpt.useme.architecture.model.usemearch.EntityType#getCategory <em>Category</em>}</li>
 *   <li>{@link fr.tpt.useme.architecture.model.usemearch.EntityType#getOwnedInteractionFeatures <em>Owned Interaction Features</em>}</li>
 * </ul>
 *
 * @see fr.tpt.useme.architecture.model.usemearch.UsemearchPackage#getEntityType()
 * @model abstract="true"
 * @generated
 */
public interface EntityType extends IdentifiedElement {
	 ...
	 * @see fr.tpt.useme.architecture.model.usemearch.UsemearchPackage#getEntityType_Category()
	 * @model
	 * @generated
	 */
	 ...
	 * @see fr.tpt.useme.architecture.model.usemearch.UsemearchPackage#getEntityType_OwnedInteractionFeatures()
